...
function (context) { // init
  ...
  if (typeof window.accounts[context.chartHandle] != "undefined") {
    ...
    popupErrorMessage("You must define an window object in the source codes of your EA that tries to refer to this indicator to manage the information about the unrealized PL. Please specify chartHandle as the index number of the window object before getting the handle of this indicator.")
  }
},
