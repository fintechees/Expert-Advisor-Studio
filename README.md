...
<tr><td><strong>Crypto Payment Gateway</strong></td><td>Integration with crypto wallets(Scatter & Metamask)<br>Now we are trying to integrate with an amazing payment platform: BitCartCC(https://bitcartcc.com, https://github.com/bitcartcc/bitcart), the founder is only 18 years old!!</td></tr>
